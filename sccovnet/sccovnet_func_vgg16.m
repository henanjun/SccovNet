...
function sccovnet_func_vgg16(net,datasetname,opts)
...
net.addLayer('conv3_sampler',dagnn.Pooling('method', 'avg', 'poolSize', [4, 4], 'stride', [4 4], 'pad', [0 0 0 0]),{'x15'},{'conv3_sampler'});   
net.addLayer('conv3_reduced',dagnn.ChannelWisePooling('ksize',2,'stride',2),{'conv3_sampler'},{'conv3_reduced'});


net.addLayer('conv4_sampler',dagnn.Pooling('method', 'avg', 'poolSize', [2, 2], 'stride', [2 2], 'pad', [0 0 0 0]),{'x22'},{'conv4_sampler'});   
net.addLayer('conv4_reduced',dagnn.ChannelWisePooling('ksize',4,'stride',4),{'conv4_sampler'},{'conv4_reduced'});

%net.addLayer('conv5_sampler',dagnn.Pooling('method', 'avg', 'poolSize', [2, 2], 'stride', [2 2], 'pad', [0 0 0 0]),{'x30'},{'conv5_sampler'});
net.addLayer('conv5_reduced',dagnn.ChannelWisePooling('ksize',4,'stride',4),{'x29'},{'conv5_reduced'});
...
nonftscpnnDirr = ['nonftscpnn','/',datasetname];
...
if opts.initilizeFromLR      
    ...
    prefetch = 1;
        ...
        inittrain.expDir = ['stage_one_train','/', datasetname] ;
...
opts.expDir = ['stage_two_train','/',datasetname];
opts.train = struct() ;
opts.train.gpus = [1];
