...
checkpoint = '/media/hnj/disk/matlab_folder/checkpoint';
datapath = '/home/hnj/matlab_folder/SCCovNet/datasetpath/';
...
if ~exist(aul_name) 
    imdb_all_name = ['imdb_all',dataset_name];
    train_ratio = train_ratio/10;
    load(imdb_all_name);
...
sccovnet_func_vgg16(net,aul_name,opts)
end