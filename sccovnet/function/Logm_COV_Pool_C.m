classdef Logm_COV_Pool_C < dagnn.Layer
  properties
    epsilon = 1e-12
  end
  ...
  methods
    ...
    function outputs = forward(obj, inputs, params)
        ...
        [outputs{1},outputs{2},outputs{3}] = vl_mylog_vc(inputs{1}, ...
                                  'epsilon',obj.epsilon);
    end
...
%      %% backwardAdvanced is modified slightly for custom layer
    ...
    function [derInputs, derParams] = backward(obj, inputs, derOutputs,outputs)
       ...
       derInputs{1} = vl_mylog_vc(inputs{1}, ...
                                   outputs{2},... % aux_S
                                   outputs{3},... % aux_V
                                   derOutputs{1});
       derParams  = {} ;
    ...
    %% constructor
    function obj = Logm_COV_Pool_C(varargin)
      obj.load(varargin) ;
    end
  end
end
