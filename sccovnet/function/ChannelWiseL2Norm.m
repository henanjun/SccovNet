classdef ChannelWiseL2Norm < dagnn.Layer
  properties
  end
  ...
  methods
    ...
    function outputs = forward(obj, inputs, params)
        ...
        [outputs{1},outputs{2}] = vl_nnmychannelnorm(inputs{1});
    end
...
%      %% backwardAdvanced is modified slightly for custom layer
    ...
    function [derInputs, derParams] = backward(obj, inputs, derOutputs,outputs)
       ...
       derInputs{1} = vl_nnmychannelnorm(inputs{1}, ...
                                   outputs{2},...
                                   derOutputs{1});
       derParams  = {} ;
    ...
    %% constructor
    function obj = ChannelWiseL2Norm(varargin)
      obj.load(varargin) ;
    end
  end
end
